package org.necrotic.alertify.ui;
...
import org.necrotic.alertify.AlertifyColorPair;
import org.necrotic.alertify.AlertifyConfig;
import org.necrotic.alertify.themes.AlertifyTheme;
import org.necrotic.alertify.util.Optional;
...
public class AlertifyWindow extends JWindow {
	...
	public AlertifyWindow(AlertifyTheme theme, AlertifyConfig config) {
		...
		this.getContentPane().setPreferredSize(new Dimension(actualWidth, actualHeight));
